...
**Проблема:** 
- Использовались `intervalIdx` и `setIdx` вместо понятных `currentCycle` и `currentSet`
...
2. **Оптимизация** - если нужно, добавить дополнительную оптимизацию нативного модуля
