...
// Импорт компонентов
import ParamRow from '../components/timer/ParamRow.tsx';
import TimerPresetSelector, { TimerPreset } from '../components/timer/TimerPresetSelector.tsx';
...
import { getCurrentUser } from '../supabaseClient.ts';
