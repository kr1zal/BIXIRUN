...
const LoginScreen = ({
    ...
    <View style={styles.authContainer}>
        ...
        <Text style={styles.authHeaderSmall}>Login</Text>
...
export default function ProfileScreen() {
    ...
    const handleSignIn = async () => {
        try {
            ...
            await checkUser();
            setPassword(''); // Очищаем пароль из соображений безопасности
        } catch (error: any) {
                ...
                {user ? (
                    ...
                    <View style={styles.userContainer}>
                        ...
                        <View style={styles.section}>
                            ...
                            >
                                {[1, 2, 3, 4].map((item) => (
                                    <View key={item} style={styles.recentProductCard}>
                                        <View style={styles.productImagePlaceholder}>
                                            <Text style={styles.productImageText}>P{item}</Text>
                                        </View>
                                        <Text style={styles.productName}>Product {item}</Text>
                                        <Text style={styles.productPrice}>${(Math.random() * 100).toFixed(2)}</Text>
                                    </View>
                                ))}
                            </ScrollView>
                        </View>
