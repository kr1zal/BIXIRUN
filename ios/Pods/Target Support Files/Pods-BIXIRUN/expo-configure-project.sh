...
with_node \
  ...
  --target "/Users/kr1zal/Documents/ii-devOps/Backup/BIXIRUN-cursor/ios/Pods/Target Support Files/Pods-BIXIRUN/ExpoModulesProvider.swift" \
  --entitlement "/Users/kr1zal/Documents/ii-devOps/Backup/BIXIRUN-cursor/ios/BIXIRUN/BIXIRUN.entitlements" \
  --platform "apple" \
  --packages "expo" "expo-asset" "expo-audio" "expo-av" "expo-blur" "expo-camera" "expo-constants" "expo-dev-launcher" "expo-dev-menu" "expo-file-system" "expo-font" "expo-haptics" "expo-image" "expo-image-picker" "expo-keep-awake" "expo-linear-gradient" "expo-linking" "expo-local-authentication" "expo-media-library" "expo-router" "expo-screen-capture" "expo-secure-store" "expo-splash-screen" "expo-symbols" "expo-system-ui" "expo-web-browser"
